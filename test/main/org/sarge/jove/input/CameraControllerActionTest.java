...
import org.sarge.jove.input.CameraControllerAction.CameraController;
import org.sarge.jove.input.CameraControllerAction.DefaultCameraController;
...
public class CameraControllerActionTest {
	...
	public void before() {
		...
		controller = DefaultCameraController.DEFAULT;
	...
	public void execute() {
		...
		final InputEvent event = new InputEvent( mock( Device.class ), new EventName( EventType.DRAG, "Button1" ), loc, null );
