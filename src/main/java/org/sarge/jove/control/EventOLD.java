 ...
 * @author Sarge
 */
public final class EventOLD extends AbstractEqualsObject {
	/**
	 * Event handler.
	 */
	@FunctionalInterface
	...
	public static final class Descriptor extends AbstractEqualsObject {
		 ...
		 */
		public static final Descriptor MOVE = new Descriptor(EventOLD.Category.MOVE);

		/**
		 * Descriptor for a zoom event.
		 */
		public static final Descriptor ZOOM = new Descriptor(EventOLD.Category.ZOOM);
	 ...
	 * @param y
	 */
	public EventOLD(Descriptor descriptor, int x, int y) {
	 ...
	 * @param descriptor Event descriptor
	 */
	public EventOLD(Descriptor descriptor) {
