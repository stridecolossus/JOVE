 ...
 * <p>
 * A native method that returns an array is an edge-case for Java since the length of the resultant array cannot be determined from the return value itself.
 * Generally the array length is provided separately, often returned as an integer-by-reference parameter in the same method.
...
//	 */
//	static final class ReturnedArrayTransformer implements AddressTransformer<ReturnedArray<?>> {
//		private final Registry registry;
//
//		/**
//		 * Constructor.
...
//
//		@Override
//		public Function<MemorySegment, ReturnedArray<?>> unmarshal() {
//			return address -> new ReturnedArray<>(address, registry);
//		}
//	}
}
