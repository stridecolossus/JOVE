 ...
 * <li>the return value is the Vulkan success code</li>
 * </ul>
 * <p>
 ...
 * <li>populate the data as a by-reference argument</li>
 * </ol>
 * @param <T> Data type
 * @author Sarge
 */
...
public interface VulkanFunction<T> {
	 ...
	 */
	void enumerate(NativeReference<Integer> count, T data);
}
