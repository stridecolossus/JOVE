...
import org.sarge.jove.platform.vulkan.pipeline.PipelineOLD.Builder.ViewportStageBuilder;
 ...
 * @author Sarge
 */
public class PipelineOLD extends LogicalDeviceHandle {
	private final PipelineOLD.Layout layout;
	 ...
	 */
	PipelineOLD(Pointer handle, LogicalDevice dev, PipelineOLD.Layout layout) {
	 ...
	 */
	public PipelineOLD.Layout layout() {
		return layout;
	}
...
//				pipeline.pDepthStencilState.maxDepthBounds = 1;
		...
		public PipelineOLD build() {
			...
			// Create pipeline
			return new PipelineOLD(pipelines[0], dev, layout);
		}
	}
