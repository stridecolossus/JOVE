 ...
 * <p>
 * The {@link #format(Stride)} convenience method can also be used to determine the format from a vertex layout:
 * <pre>
...
public class FormatBuilder {
	 ...
	 * <p>
	 * The Vulkan numeric formats correspond the general {@link Stride.Type} equivalents with the following special cases:
	 * <ul>
