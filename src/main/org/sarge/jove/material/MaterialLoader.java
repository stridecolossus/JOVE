...
public class MaterialLoader {
	...
	/**
	 * Convenience constructor using a single data-source for material files, shaders and textures.
	 * @param src Data-source
	 * @param sys Rendering system
	 */
	public MaterialLoader( DataSource src, RenderingSystem sys  ) {
		this( src, new ShaderLoader( src, sys ), new TextureLoader( src, sys ), sys );
	}
	...
	private static RenderProperty loadRenderProperty( DocumentElement root ) throws IOException {
		...
		case "face-cull":
			return new FaceCullProperty( root.getEnum( "face", null, Face.class ) );
