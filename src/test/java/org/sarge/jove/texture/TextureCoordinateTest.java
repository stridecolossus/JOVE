...
public class TextureCoordinateTest {
	@Test
	public void one() {
		final TextureCoordinate one = TextureCoordinate.of(4);
		assertNotNull(one);
		assertEquals(1, one.size());
		assertFloatArrayEquals(new float[]{4}, one.toArray());
		assertEquals(true, one.equals(one));
		assertEquals(false, one.equals(null));
		assertEquals(false, one.equals(TextureCoordinate.of(7)));
		assertEquals(false, one.equals(TextureCoordinate.of(7, 8)));
		assertEquals(false, one.equals(TextureCoordinate.of(7, 8, 9)));
	}

	@Test
	public void two() {
		final TextureCoordinate two = TextureCoordinate.of(4, 5);
		assertNotNull(two);
		assertEquals(2, two.size());
		assertFloatArrayEquals(new float[]{4, 5}, two.toArray());
		assertEquals(true, two.equals(two));
		assertEquals(false, two.equals(null));
		assertEquals(false, two.equals(TextureCoordinate.of(7)));
		assertEquals(false, two.equals(TextureCoordinate.of(7, 8)));
		assertEquals(false, two.equals(TextureCoordinate.of(7, 8, 9)));
	}

	@Test
	public void three() {
		final TextureCoordinate three = TextureCoordinate.of(4,5, 6);
		assertNotNull(three);
		...
		assertEquals(false, three.equals(TextureCoordinate.of(7)));
		assertEquals(false, three.equals(TextureCoordinate.of(7, 8)));
		assertEquals(false, three.equals(TextureCoordinate.of(7, 8, 9)));
	}
