...
public class NodeTest extends MockitoTestCase {
	...
	public void constructor() {
		...
		assertEquals( null, node.getRenderable() );
		...
		assertEquals( DefaultRenderStage.OPAQUE, node.getRenderStage() );
	}
	...
	public void setTransform() {
		...
		assertEquals( other.multiply( trans ), node.getWorldMatrix() );
...
//	}
	...
	@Test
	public void setRenderStage() {
		node.setRenderStage( DefaultRenderStage.SKY );
		assertEquals( DefaultRenderStage.SKY, node.getRenderStage() );
	}
