...
public class TextureCoordinateTest {
	...
	void one() {
		...
		assertEquals(one, TextureCoordinate.of(new float[]{4}));
	}
	...
	void two() {
		...
		assertEquals(two, TextureCoordinate.of(new float[]{4, 5}));
	}
	...
	void three() {
		...
		assertEquals(three, TextureCoordinate.of(new float[]{4, 5, 6}));
	}
